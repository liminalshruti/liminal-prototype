...
# overwritten by `npm run design:gen` and fail `npm run design:check`.
#
# Change a VALUE  → edit the canon token upstream, sync, regenerate.
...
typography:
  ...
  headline:
    ...
    lineHeight: 1.18
  body:
    fontFamily: "Space Grotesk, Geist, system-ui, -apple-system, BlinkMacSystemFont, sans-serif"
    fontSize: "14px"
    fontWeight: 400
    lineHeight: 1.5
  read:
    ...
    lineHeight: 1.55
  label:
    fontFamily: "Space Mono, Geist Mono, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace"
    fontSize: "10px"
    fontWeight: 400
    lineHeight: 1
