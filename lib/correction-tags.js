 ...
 *
 * RECONCILED (2026-07-01 · docs/architecture/ONTOLOGY_RECONCILIATION_2026-07-01.md):
 *   CORRECTION_TAG_LABELS accepted upstream — liminal-agents-v1 branch
 *   `shruti/ontology-single-source` adds LABELS beside TAGS/DESCRIPTIONS with a
 *   package subpath export. This file remains a hand-synced MIRROR of that
 *   source (this repo is build-free; no npm dependency). Sync check: LABELS
 *   here must match `liminal-agents-v1/lib/corrections` exports.
 *
