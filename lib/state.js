...
import {
  ...
  BUSINESS_SCENARIOS, BUSINESS_TILES_FOR_CASE, BUSINESS_OPERATOR,
  PERSONAL_THREADS, PERSONAL_TILES_FOR_THREAD, PERSONAL_OPERATOR,
} from "../v0_3_config.js";
...
export const slated     = { personal: {}, team: {}, business: {} };
export const corrected  = { personal: {}, team: {}, business: {} };
export const auditRows  = { personal: [], team: [], business: [] };
export const vaultCount = { personal: 38, team: 14, business: 247 };
