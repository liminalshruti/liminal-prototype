...
import { BUSINESS_SCENARIOS } from "../data/business.js";
import { SAMSEED_SUBJECTS } from "../data/sam-seed.js";
...
function siblingContexts() {
  ...
  if (activeProductId === "sam-seed") return SAMSEED_SUBJECTS.map(s => s.id);
  return [];
}
