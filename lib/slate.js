 ...
 */
import {
  TEAM_TILES_FOR_SUBJECT, BUSINESS_OPERATOR, BUSINESS_SCENARIOS,
  CONSENT_CLASSES,
} from "../v0_3_config.js";
import {
...
export function renderSlate(ctx) {
  ...
  /* Brian DRIFT sparkline · the demo's killing-feature visual */
...
export function renderBrief() {
  ...
  /* annotated calibration · click to commit a correction */
  body.querySelectorAll(".annotated").forEach(span => {
    span.addEventListener("click", () => {
      ...
      const evt = new CustomEvent("liminal:toast", { detail: "+ 1 calibration stored · vault committed" });
