/* lib/beat-marginalia.js · presenter aid for the stitched demo · 2026-06-25
   ──────────────────────────────────────────────────────────────────────
...
(function () {
  ...
  var NOTES = {
    ...
    3: 'credits are not currency. applied is not verified. the receipt is the asset.',
    4: 'recorded hackathon artifact. a public-network claim still needs its transaction-specific receipt.'
  };
  var note = NOTES[beat];
  if (!note) return;
  ...
  css.textContent = [
    '#beat-note{position:fixed;left:18px;bottom:104px;z-index:9998;max-width:264px;',
    '  font-family:"Caveat",var(--font-serif,cursive);font-size:20px;line-height:1.25;',
