/* lib/beat-rail.js · the demo spine · stitched walkthrough 2026-06-25
   ──────────────────────────────────────────────────────────────────────
   Injects ONE persistent beat rail (1·FEEL 2·UNDERSTAND 3·CONTROL 4·PROVE,
   current beat lit) as a fixed top-center overlay, so the four demo surfaces
   read as one sequence instead of four destinations.
...
(function () {
  ...
  var BEATS = [
    ...
    { n: 3, arc: 'CONTROL',    href: base + '11-govern.html' },
