 ...
 *
 * 9 agents in 4 registers · one is "currently reading" at a time, rotating
 ...
 *
 * ONTOLOGY STATUS (2026-07-01 · docs/architecture/ONTOLOGY_RECONCILIATION_2026-07-01.md):
 * this roster is a PRESENTATION-LAYER DEMO CAST, not an ontology claim. The
 * schema authority is liminal-agents-v1 (INTROSPECTIVE_AGENTS 12x4 +
 * AGENCY_AGENTS 4). The register names here (diligence/outreach/synthesis/
 * judgment) are the brand chrome tokens doing skin duty — owned by the design
 * canon, distinct from canon's introspective registers. Surfaces needing
 * production-real names use AGENCY_AGENTS (Analyst/SDR/Auditor/Forensic).
 *
